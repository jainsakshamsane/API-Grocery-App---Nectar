        ...
        applyfilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  FilterSearchapply applyfilter = new FilterSearchapply(Brand, selectedPrice, categoryId, SubCategory, selectedpricemin);
                ...
                Call<FilterSearchRequest> filterCall = RetrofitClient.getInstance().getMyApi().filterSearch(authorizationHeader, fil);
                filterCall.enqueue(new Callback<FilterSearchRequest>() {
                    @Override
                    public void onResponse(Call<FilterSearchRequest> call, Response<FilterSearchRequest> response) {
                        if (response.isSuccessful()) {
                            FilterSearchRequest filterResponse = response.body();
                            if (filterResponse != null && filterResponse.getData().getProducts() != null) {

                                alldata7 = filterResponse.getData().getProducts();
                                alldata8 = filterResponse.getData().getImage();
                    ...
                    @Override
                    public void onFailure(Call<FilterSearchRequest> call, Throwable t) {
